...
[[nodiscard]] auto try_sequence(std::size_t total, int base_flags, std::initializer_list<int> flags_list) noexcept
    -> void* {
...
Arena::Arena(std::byte* base, const config::MemoryConfig& cfg) noexcept
    : base_(base)
    , config_(cfg)
